...
int main() {
    ...
    // std::out buffers the content before sending it to the stdout.
    // you can force sending the buffer content to stdout using std::flush
    std::cout << "This is going to flush out." << std::endl << std::flush;
    ...
    // It affects only the next value to be printed.
    ...
    std::cout << "d : " << d << std::endl; // 34.100000000000001421
    std::cout << "e : " << e << std::endl; // 101.98999999999999488
    std::cout << "f : " << f << std::endl; // 12
    std::cout << "g : " << g << std::endl; // 55
    ...
    std::cout << "d : " << d << std::endl; // 34.100000000000001421
    std::cout << "e : " << e << std::endl; // 101.98999999999999488
    std::cout << "f : " << f << std::endl; // 12.000000000000000000
    std::cout << "g : " << g << std::endl; // 55
